...
const upload = multer({
  ...
  limits: {
    fileSize: (Number.isFinite(parseInt(process.env.UPLOAD_SIZE_LIMIT, 10)) && parseInt(process.env.UPLOAD_SIZE_LIMIT, 10) > 0)
      ? parseInt(process.env.UPLOAD_SIZE_LIMIT, 10)
