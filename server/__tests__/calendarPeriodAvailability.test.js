...
describe('calendar period availability and Israel boundaries', () => {
  test('returns only actual months, preserves gaps, and always includes current', () => {
    expect(computeAvailablePeriodOffsets(
      ['2026-07', '2026-06', '2026-04', 'not-a-month', '2026-08'],
      new Date('2026-07-12T12:00:00+03:00'),
    )).toEqual([0, -1, -3]);
  });
