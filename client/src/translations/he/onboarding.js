...
export default {
  ...
  steps: {
    profile: {
      ...
      subtitle: "הגדירו את הפרופיל וההעדפות שלכם"
    },
    education: {
      title: "למדו את היסודות",
      subtitle: "איך סנכרון בנק וכרטיסים שומר על הנתונים מעודכנים"
    },
    billingCycle: {
      title: "מחזור פיננסי",
      subtitle: "ספרו לנו מתי מתחיל החודש הפיננסי שלכם"
    },
    connectSources: {
      title: "חיבור מקורות",
      subtitle: "חשבונות בנק מול חברות אשראי — ואיך לחבר אותם"
    }
  },
  connectSources: {
    title: "חברו את הבנק והכרטיסים",
    subtitle: "SpendWise מסנכרן את העסקאות שלכם אוטומטית. קודם, הדבר האחד ששווה להכיר:",
    banksTitle: "חשבונות בנק",
    banksBlurb: "לשם נכנסת המשכורת ומשם יוצאים החיובים הישירים.",
    banksProvides: "יתרת חשבון אמיתית + היסטוריית עסקאות מלאה",
    cardsTitle: "חברות אשראי",
    cardsBlurb: "שם כל רכישה מפורטת לפני החיוב החודשי.",
    cardsProvides: "חיובים מפורטים — הם נרשמים מאוחר יותר כחיוב מרוכז אחד בבנק",
    relationship: "דוגמה: 20 רכישות כרטיס החודש מופיעות בנפרד מחברת האשראי, ואז מופיעות כחיוב מרוכז אחד בחשבון הבנק. חיבור שניהם נותן לכם גם את הפירוט וגם את השורה התחתונה.",
    connectNow: "חברו מקור עכשיו",
    connectNowHint: "ניקח אתכם לעמוד סנכרון הבנק מיד אחרי ההגדרה",
    later: "אעשה זאת מאוחר יותר",
    laterHint: "אפשר לחבר בכל עת מעמוד סנכרון הבנק"
  },
  billingCycle: {
    title: "מתי מתחיל החודש הפיננסי שלך?",
    subtitle: "בדרך כלל זה יום המשכורת. אנחנו משתמשים בו כדי לחשב את סיכומי הדשבורד לתקופה אמיתית וקבועה — לא סתם 30 הימים האחרונים.",
    dayOfMonth: "יום {{day}}",
    pickAnyDay: "או בחרו כל יום אחר",
    selectedSummary: "החודש הפיננסי שלך מתחיל ביום {{day}} ומסתיים יום לפני יום {{day}} בחודש הבא.",
    changeLater: "אפשר לשנות את זה בכל עת בהגדרות הפרופיל."
  },
  welcome: {
    title: "ברוכים הבאים ל-SpendWise!",
    subtitle: "החבר הפיננסי החכם שלכם",
    description: "קחו שליטה על הכספים שלכם עם מעקב הוצאות חזק, תובנות ואוטומציה.",
    features: {
      tracking: {
        title: "מעקב חכם",
        description: "סיווג אוטומטי ומעקב אחר ההוצאות שלכם עם תובנות מבוססות בינה מלאכותית"
      },
      analytics: {
        title: "אנליטיקה ויזואלית",
        description: "גרפים ודוחות יפים כדי להבין את דפוסי ההוצאות שלכם"
      },
      goals: {
        title: "יעדים פיננסיים",
        description: "הגדירו ועקבו אחר תקציבים, יעדי חסכון ואבני דרך פיננסיות"
      },
      security: {
      ...
      mobile: {
        title: "מובייל-ראשון",
        description: "חוויה מושלמת על כל המכשירים - טלפון, טאבלט ומחשב"
      },
      automation: {
        title: "אוטומציה חכמה",
        description: "עסקאות חוזרות וסיווג אינטליגנטי חוסכים לכם זמן"
      }
    },
    benefits: {
      title: "למה לבחור ב-SpendWise?",
      items: {
        easy: "ממשק קל לשימוש",
        powerful: "אנליטיקה חזקה",
        secure: "אבטחה ברמת בנק",
        mobile: "עובד בכל מקום"
      }
    },
    cta: {
      getStarted: "בואו נתחיל",
      letsGo: "בואו!",
      continue: "המשיכו בהתקנה"
    },
    stats: {
      users: "50K+ משתמשים",
      tracked: "$2M+ במעקב",
      categories: "100+ קטגוריות",
      countries: "25+ מדינות"
    }
  },
  templates: {
    ...
    autoSelect: "לחצו Enter או לחצו מחוץ לתיבה לבחירה",
    customName: "שם התבנית (למשל, \"ניקיון משק\")",
    customAmount: "סכום",
    customHint: "צרו עסקה חוזרת משלכם",
    remove: "הסר",
    readyToCreate: "אלה יישמרו כתבניות עסקאות חוזרות",
    info: "אלה הם הגדרות מהירות. תוכלו ליצור עסקאות חוזרות מתקדמות עם שליטה מלאה באמצעות כפתור ה-+ באפליקציה הראשית.",
    popular: {
