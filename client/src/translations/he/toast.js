...
export default {
  ...
  transactions: {
    ...
    bulkDeletePartialFail: "{{failed}} עסקאות נכשלו במחיקה",
    bulkDeleteFailed: "פעולת המחיקה הקבוצתית נכשלה. אנא נסו שוב.",
  ...
  settings: {
    ...
    themeChangedSession: "ערכת נושא עודכנה ל־{{theme}} (לסשן הנוכחי בלבד).",
    languageChangedSession: "השפה עודכנה (לסשן הנוכחי בלבד).",
    sessionOnly: "שינוי זמני לסשן בלבד. העדפות קבועות נטענות מדף הפרופיל בכל התחברות.",
