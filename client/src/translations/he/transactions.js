...
export default {
  ...
  total: "סה״כ",
  readError: {
    failed: "לא הצלחנו לטעון את העסקאות. זה לא אומר שאין עסקאות בחשבון.",
    stale: "לא הצלחנו לרענן את העסקאות. מוצגים הנתונים האחרונים שנטענו.",
    retry: "ניסיון נוסף"
  },
  types: {
    income: "הכנסה",
  ...
  detail: {
    ...
    category: "קטגוריה",
    installment: "תשלום",
    installmentValue: "{{current}} מתוך {{total}}",
  ...
  stats: {
    net: "נטו",
    inflows: "תנועות נכנסות",
    outflows: "תנועות יוצאות",
