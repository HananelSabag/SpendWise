...
export default {
  ...
  overview: {
    ...
    notSyncing: 'המידע שלך לא מתעדכן',
    stalledBody: 'מקור אחד ממתין בתור ואף אחד לא אוסף אותו. בדוק בלשונית הסוכן.',
    stalledBody_plural: '{{count}} מקורות ממתינים בתור ואף אחד לא אוסף אותם. בדוק בלשונית הסוכן.',
  ...
  // מצב אמיתי מחושב — מה באמת קורה, ולא מה שכתוב בעמודת הסטטוס
  statusSyncing: 'מסנכרן',
  statusQueued: 'בתור',
  statusWaiting: 'לא נאסף',
  statusAgentOffline: 'הסוכן לא פעיל',
  statusStalled: 'לא מתעדכן',
  statusNeedsCredentials: 'צריך להזין מחדש',
  healthWaitingForAgent: 'בקשת הסנכרון ממתינה ואף סוכן לא אסף אותה.',
  healthAgentOffline: 'המחשב המשויך שלך לא דיווח, ולכן שום דבר לא מסתנכרן.',
  healthStalled: 'לא הגיע מידע חדש מהמקור הזה.',
  healthNeedsCredentials: 'פרטי ההתחברות נעולים לסוכן סנכרון אחר. יש להזין אותם מחדש.',
  healthStaleFor: 'אין מידע חדש כבר יום',
  healthStaleFor_plural: 'אין מידע חדש כבר {{count}} ימים',
  ...
  syncMethodSecurityTitle: 'כלל אבטחה חשוב',
  syncMethodSecurityRule: 'ה-Agent עצמו מבקש רק קוד חיבור בן 8 תווים. SpendWise או התמיכה לעולם לא יבקשו ממך לשלוח סיסמת בנק בצ׳אט, במייל או בטלפון.',
  syncMethodSecurityDetails: 'איך פרטי ההתחברות מוגנים?',
  syncMethodSecurityEncryption: 'פרטי הבנק מוצפנים כבר בדפדפן עבור מכונת הסנכרון שבחרת; שרת האפליקציה שומר מעטפת מוצפנת ואינו יכול לקרוא אותה.',
  syncMethodSecurityLocalKey: 'רק מכונת הסנכרון מחזיקה במפתח הפרטי. פרטי הכניסה נפתחים לזמן קצר בזיכרון בזמן ההתחברות לבנק ואינם נשמרים כטקסט גלוי.',
  syncMethodSecurityData: 'יתרות ועסקאות שסונכרנו נשלחות לחשבון SpendWise שלך בחיבור HTTPS מוצפן — זה המידע שמאפשר להציג את הדשבורד.',
  syncMethodSecuritySource: 'לצפייה בקוד המקור של ה-Agent',
  ...
  syncMethodDeviceSeen: 'דיווח אחרון בשעה {{time}}',
  syncMethodDeviceSilent: 'לא דיווח מאז {{time}} — הפעל את הסוכן על המחשב הזה, או נתק את השיוך כדי ש-SpendWise יסנכרן במקומך.',
  syncMethodDeviceNeverSeen: 'המחשב הזה מעולם לא דיווח — הפעל עליו את הסוכן, או נתק את השיוך כדי ש-SpendWise יסנכרן במקומך.',
  ...
  syncMethodSwitchToOwnConfirmBody: 'אחרי חיבור המחשב שלך תצטרך לחבר מחדש את הבנקים - התחברויות שמורות לא עוברות אוטומטית למכשיר החדש. עד שתעשה זאת, החיבורים האלה יפסיקו להסתנכרן.',
  syncMethodUnpairKeepsAll: '{{count}} החיבורים שלך ימשיכו לעבוד — הם עדיין חתומים לשרת של SpendWise, ואין צורך לחבר שום דבר מחדש.',
