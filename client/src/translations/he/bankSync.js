...
export default {
  ...
  overview: {
    allCurrent: 'מערך הסנכרון שלך מעודכן',
    syncingNow: 'סנכרון רץ עכשיו',
    needsAttention: 'אחד החיבורים דורש טיפול',
    healthyBody: 'כל המקורות הפעילים מוכנים. הדשבורד משתמש רק בחשבונות שבחרת לכלול.',
    statusBody: 'פתח את ניהול החשבונות כדי לראות איזה מקור מסתנכרן או דורש תיקון.',
    lastSystemSync: 'סנכרון אחרון שהושלם: {{time}}',
    connectedSources: 'מקורות מחוברים',
    includedAccounts: 'חשבונות שנכללים',
    newImported: 'חדשות בסנכרון האחרון',
    needAttention: 'דורשים טיפול',
    dashboardScopeTitle: 'מה נכנס לחישובים בדשבורד',
    allAccountsIncluded: 'כל החשבונות והכרטיסים שנמצאו משתתפים כרגע בסכומי הדשבורד.',
    excludedAccounts: 'חשבון אחד מוחרג מסנכרונים עתידיים ומסכומי הדשבורד; ההיסטוריה שכבר נשמרה נשארת זמינה.',
    excludedAccounts_plural: '{{count}} חשבונות מוחרגים מסנכרונים עתידיים ומסכומי הדשבורד; ההיסטוריה שכבר נשמרה נשארת זמינה.',
    manageScope: 'ניהול חשבונות',
    sourcesTitle: 'מצב המקורות',
    sourcesSubtitle: 'לחיצה על מקור מאפשרת לסנכרן, להשהות, לעדכן פרטים או לשנות טוגלים.',
    processedTotal: '{{count}} עובדו בריצות האחרונות',
    sourceScope: '{{enabled}} מתוך {{total}} חשבונות נכללים',
    waitingForAccounts: 'ממתין לגילוי החשבונות הראשון',
    newShort: 'חדשות',
    cleanTotalsTitle: 'איך SpendWise שומר על חישוב נקי',
    bankFactTitle: 'חשבון הבנק הוא עובדת המזומן',
    bankFactBody: 'יתרה, משכורת, הוראות קבע, עמלות, מזומן והחזרי הלוואה מגיעים מהבנק.',
    cardFactTitle: 'האשראי מספק פירוט קניות',
    cardFactBody: 'חברות האשראי מוסיפות קניות מפורטות ותאריכי ספק; הן לעולם לא יוצרות יתרת בנק.',
    dedupeTitle: 'חיוב מרוכז נספר פעם אחת',
    dedupeBody: 'כשקיים פירוט קניות, החיוב המאוחר בבנק הוא ראיית התאמה ולא הוצאה חדשה.',
    connectFirst: 'חברו בנק או חברת אשראי ראשונים',
  },
  ...
  statsScopeNote: 'הכנסות והוצאות מתייחסות לחודש הקלנדרי שנבחר; מונה העסקאות כולל את כל מה שסונכרן אי פעם.',
  cardStatsScopeNote: 'פעילות האשראי מחושבת לפי תאריך הקנייה העובדתי. תאריך הדוח או הפירעון נשמר בנפרד לצורך אימות; מונה העסקאות כולל את כל מה שסונכרן אי פעם.',
  ...
  howItWorksStep4: 'בתוצאת הסנכרון רואים מה נוסף, מה עודכן ומה כבר היה מוכר — כדי שכל שינוי יישאר ניתן לבדיקה',
