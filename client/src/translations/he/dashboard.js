...
export default {
  ...
  cycle: {
    ...
    hint: "המשכורת הבאה סוגרת את המחזור",
    soFar: "עד עכשיו",
    income: "הכנסות",
    expenses: "הוצאות",
    ...
    control: {
      ...
      reset: "חזרה לאוטומטי",
      resetRule: "המחזור הזה נסגר כשהמשכורת הבאה נכנסת, סביב {{date}}.",
      ...
      reason: {
        ...
        opening_salary_previous_cycle: "המשכורת פתחה את חלון הבנק, אבל כלכלית היא סוגרת את מחזור העבודה הקודם.",
