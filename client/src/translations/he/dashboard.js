...
export default {
  ...
  recentTransactions: {
    ...
    viewAll: "לכל העסקאות",
    noTransactions: "אין תנועות עדיין",
    noTransactionsDescription: "אפשר להוסיף עסקה ידנית או לחבר בנק ולטעון את התנועות מהחשבון.",
    getStarted: "אפשר להוסיף עסקה ידנית או לחבר בנק ולטעון את התנועות מהחשבון.",
    addFirst: "הוסף תנועה",
    loading: "טוען תנועות...",
    error: "לא הצלחנו לטעון את התנועות",
  ...
  dashboardError: "לא הצלחנו לטעון את דף הבית",
  dashboardErrorMessage: "הנתונים לא זמינים כרגע. אפשר לנסות שוב; אין צורך לחבר מחדש את החשבון.",
  retryingIn: "ניסיון חוזר בעוד {{countdown}} שניות…",
  goToProfile: "עבור לפרופיל",
  refreshed: "לוח הבקרה רוענן בהצלחה",
  refreshError: "לא הצלחנו לרענן את כל הנתונים. אפשר לנסות שוב.",
  staleDashboard: "חלק מהנתונים לא התעדכנו. מוצגת תמונת המצב האחרונה שנטענה.",
  greetings: {
    morning: "בוקר טוב",
