...
export default {
  ...
  period: {
    ...
    navigator: "ניווט בין תקופות פיננסיות",
    older: "תקופה ישנה יותר",
    newer: "תקופה חדשה יותר",
    now: "עכשיו",
    last: "קודמת",
    twoAgo: "לפני 2",
    backToCurrent: "חזרה לתקופה הנוכחית",
    income: "הכנסות",
    expenses: "הוצאות",
    net: "נטו",
    cycleDay: "יום מחזור {{day}}",
    cycleHint: "מחזור החיוב שלך מתחיל ביום {{day}} בכל חודש",
    notSet: "הגדר את יום המחזור הפיננסי כדי שהסכומים יתאימו לחודש האמיתי שלך, לא ל-1 בחודש"
  },
  moneyModel: {
    title: "איך נספרת התקופה הזו",
    subtitle: "בנקים מציגים תזרים אמיתי של החשבון. חברות אשראי מציגות פירוט קניות. SpendWise נמנע מלספור את אותו חיוב אשראי פעמיים.",
    cashflowSubtitle: "אנחנו סופרים כסף שבאמת עבר בחשבון הבנק — כולל חיוב האשראי. הקניות הבודדות בכרטיס מופיעות בפירוק, לא נספרות שוב.",
    cardBill: "חיוב אשראי (יורד מהבנק)",
    bankDirect: "תנועות בחשבון הבנק",
    bankDirectHint: "כסף שבאמת יצא מחשבון הבנק או נכנס אליו.",
    statementSubtitle: "כרטיסי אשראי נספרים לפי תאריך החיוב. חיוב הבנק המרוכז לא נספר שוב כשיש פירוט מחברת האשראי.",
    cardPurchases: "חיובי דוח כרטיס האשראי",
    cardPurchasesHint: "חיובים מפורטים מחברת האשראי, נספרים לפי תאריך החיוב.",
