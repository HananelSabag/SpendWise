...
export default {
  ...
  cycleV2: {
    ...
    useEstimate: "Include card estimate",
    estimateHint: "Updates the forecast immediately",
    saving: "Saving…",
    syncing: "Updating…",
    liveBankBalance: "Live balance from connected banks",
    partialBalance: "Some accounts do not report a balance",
    afterKnownHint: "Income and expenses already known to the engine",
    forecastHint: "Known movements plus conservative card growth",
    forecastOffHint: "Historical card growth is not included",
    ...
    linkRecurring: "Link to recurring rule"
  },
  merchantWatch: {
