...
export default {
  ...
  period: {
    ...
    navigator: "Financial period navigator",
    older: "Older period",
    newer: "Newer period",
    now: "Now",
    last: "Last",
    twoAgo: "2 ago",
    backToCurrent: "Back to current period",
    income: "Income",
    expenses: "Expenses",
    net: "Net",
  ...
  moneyModel: {
    ...
    cardPurchases: "Credit-card statement charges",
    cardPurchasesHint: "Itemized charges from credit companies, counted by payment date.",
