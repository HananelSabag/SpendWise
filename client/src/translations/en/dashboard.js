...
export default {
  ...
  recentTransactions: {
    ...
    viewAll: "View All",
    noTransactions: "No transactions yet",
    noTransactionsDescription: "Add a transaction manually or connect a bank to load your account activity.",
    getStarted: "Add a transaction manually or connect a bank to load your account activity.",
  ...
  dashboardError: "We couldn't load your home screen",
  dashboardErrorMessage: "Your data is temporarily unavailable. Try again; you don't need to reconnect your account.",
  retryingIn: "Retrying in {{countdown}}s…",
  goToProfile: "Go to profile",
  analytics: "Analytics",
  goals: "Goals",
  refreshed: "Dashboard refreshed successfully",
  refreshError: "Some data could not be refreshed. Please try again.",
  staleDashboard: "Some data could not be updated. The last loaded snapshot is shown.",
  greetings: {
