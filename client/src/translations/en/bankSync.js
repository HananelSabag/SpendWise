...
export default {
  ...
  overview: {
    allCurrent: 'Your sync setup is up to date',
    syncingNow: 'A sync is running now',
    needsAttention: 'A connection needs attention',
    healthyBody: 'Your active sources are ready. The dashboard uses only the accounts you include below.',
    statusBody: 'Open account management to see the source that is syncing or needs a fix.',
    lastSystemSync: 'Latest completed sync: {{time}}',
    connectedSources: 'Connected sources',
    includedAccounts: 'Included accounts',
    newImported: 'New in latest sync',
    needAttention: 'Need attention',
    dashboardScopeTitle: 'What counts in your dashboard',
    allAccountsIncluded: 'Every discovered account and card currently contributes to dashboard totals.',
    excludedAccounts: '{{count}} account is excluded from future imports and dashboard totals; its saved history stays available.',
    excludedAccounts_plural: '{{count}} accounts are excluded from future imports and dashboard totals; their saved history stays available.',
    manageScope: 'Manage accounts',
    sourcesTitle: 'Source status',
    sourcesSubtitle: 'Tap a source to sync, pause, update credentials, or change account toggles.',
    processedTotal: '{{count}} processed in the latest runs',
    sourceScope: '{{enabled}} of {{total}} accounts included',
    waitingForAccounts: 'Waiting for the first account discovery',
    newShort: 'new',
    cleanTotalsTitle: 'How SpendWise keeps the totals clean',
    bankFactTitle: 'Bank accounts are cash facts',
    bankFactBody: 'Balances, salary, direct debits, fees, cash and loan repayments come from the bank.',
    cardFactTitle: 'Cards provide purchase detail',
    cardFactBody: 'Credit companies add itemized purchases and provider dates; they never create a bank balance.',
    dedupeTitle: 'Settlements count once',
  ...
  howItWorksStep4: 'The latest result shows what was new, updated, or already known so sync changes stay auditable',
