...
export default {
  ...
  overview: {
    ...
    notSyncing: 'Your data is not updating',
    stalledBody: '{{count}} source is queued but nothing is collecting it. Check the Agent tab.',
    stalledBody_plural: '{{count}} sources are queued but nothing is collecting them. Check the Agent tab.',
  ...
  // Derived health — what is really happening, not what the status column says
  statusSyncing: 'Syncing',
  statusQueued: 'Queued',
  statusWaiting: 'Not picked up',
  statusAgentOffline: 'Agent offline',
  statusStalled: 'Not updating',
  statusNeedsCredentials: 'Re-enter details',
  healthWaitingForAgent: 'The sync request has been waiting and no agent picked it up.',
  healthAgentOffline: 'Your paired computer has not reported in, so nothing can sync.',
  healthStalled: 'No new data has arrived from this source.',
  healthNeedsCredentials: 'These login details are locked to a different sync agent. Re-enter them.',
  healthStaleFor: 'Nothing new for {{count}} day',
  healthStaleFor_plural: 'Nothing new for {{count}} days',
  ...
  syncMethodSecurityTitle: 'One important security rule',
  syncMethodSecurityRule: 'The Agent itself asks only for an 8-character pairing code. SpendWise and support will never ask you to send a bank password by chat, email, or phone.',
  syncMethodSecurityDetails: 'How are my bank credentials protected?',
  syncMethodSecurityEncryption: 'Bank credentials are encrypted in your browser for the sync machine you selected; the application server stores an encrypted envelope it cannot read.',
  syncMethodSecurityLocalKey: 'Only the sync machine holds the private key. Login details are opened briefly in memory while connecting to the bank and are never stored as plain text.',
  syncMethodSecurityData: 'Synced balances and transactions are sent to your SpendWise account over encrypted HTTPS — this is the data used to build your dashboard.',
  syncMethodSecuritySource: 'Review the Agent source code',
  ...
  syncMethodDeviceSeen: 'Last reported in at {{time}}',
  syncMethodDeviceSilent: 'Has not reported since {{time}} — start the Agent on that computer, or unpair to let SpendWise sync for you.',
  syncMethodDeviceNeverSeen: 'This computer has never reported in — start the Agent on it, or unpair to let SpendWise sync for you.',
  ...
  syncMethodSwitchToOwnConfirmBody: "After connecting your own computer you'll need to reconnect your banks — already-saved logins can't carry over to the new device. Until you do, those connections will stop syncing.",
  syncMethodUnpairKeepsAll: 'Your {{count}} connections keep working — they are still sealed to the SpendWise host, so nothing needs reconnecting.',
