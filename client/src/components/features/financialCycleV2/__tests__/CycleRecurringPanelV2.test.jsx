...
describe('selectRecurringCandidates', () => {
  ...
  it('excludes settlements, income, locked rows, and already-linked transactions', () => {
    const decisions = [
    ...
    expect(selectRecurringCandidates(decisions).map((item) => item.transactionId)).toEqual([5]);
  });
});
