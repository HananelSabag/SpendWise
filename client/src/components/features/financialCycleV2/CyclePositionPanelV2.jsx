  ...
  return (
    <section aria-labelledby="cycle-position-heading">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-3">
        ...
        <BalanceStep icon={CheckCircle2} label={t('cycleV2.afterKnown')} value={afterKnown} hint={t('cycleV2.afterKnownHint')} formatCurrency={formatCurrency} />
        <BalanceStep icon={Sparkles} label={t('cycleV2.forecast')} value={useEstimates ? forecast : afterKnown} hint={useEstimates ? t('cycleV2.forecastHint') : t('cycleV2.forecastOffHint')} formatCurrency={formatCurrency} emphasis />
      </div>
