                            ...
                            <motion.button
                              ...
                              className={`group p-2 rounded-lg border transition-all flex flex-col items-center gap-1 text-center min-h-[60px] relative ${
                                isSelected
                                  ...
                                  : 'border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 bg-white dark:bg-gray-800 hover:scale-102 hover:shadow-sm'
                              }`}
                            ...
                            >
                              ...
                              {isSelected && (
                                <motion.div
                                  initial={{ scale: 0 }}
                                  animate={{ scale: 1 }}
                                  className="absolute -top-1 -right-1 w-4 h-4 bg-blue-500 rounded-full flex items-center justify-center border border-white dark:border-gray-800 shadow-sm"
                                >
