...
const translations = {
  ...
  he: {
    ...
    auth: {
      ...
      // Enhanced modal messages for better UX
      emailNotVerifiedModalTitle: 'האימייל לא אומת',
      emailNotVerifiedModalMessage: 'לא ביצעת אימות של כתובת האימייל שלך עדיין.',
      checkEmailSpamMessage: 'בדוק את תיבת הדואר ואת תיקיית הספאם. לפעמים אימיילי האימות נכנסים לשם.',
      stillNoEmailMessage: 'עדיין לא רואה את האימייל?',
      clickToResendMessage: 'לחץ כאן לשליחה חוזרת',
      resendVerificationSuccess: 'אימייל אימות נשלח מחדש בהצלחה!',
      checkEmailAgainMessage: 'בדוק שוב את תיבת הדואר (כולל תיקיית הספאם)',
